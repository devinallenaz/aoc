...
public static class InputHelper
{
    ...
    {
        if (test && problem2 && File.Exists($"{Environment.GetFolderPath(Environment.SpecialFolder.UserProfile)}/dallen/projects/Aoc/Aoc{Runner.Year}/Input/day{day}_test_2.txt"))
        {
